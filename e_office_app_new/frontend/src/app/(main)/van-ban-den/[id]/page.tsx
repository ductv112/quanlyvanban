      ...
      <Row gutter={16}>
        ...
        <Col xs={24} lg={8}>
          ...
          <div style={{
            ...
            <div className="section-title" style={{ marginBottom: 12 }}><SendOutlined /> Phân công xử lý ({recipients.length})</div>
            {recipients.length === 0 ? (
              <div style={{ textAlign: 'center', padding: '16px 0', color: '#bfbfbf' }}>Chưa phân công cho phòng/cá nhân nào xử lý</div>
            ) : (
              <div>
                {recipients.map((r) => (
