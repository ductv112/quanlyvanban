...
#### 1.1.3. Các trường nhập trên form đăng nhập
...
#### 1.1.5. Các thông báo của hệ thống khi đăng nhập
...
### 1.2. MÀN HÌNH THÔNG TIN CÁ NHÂN
...
#### 1.2.3. Các thông tin hiển thị (chỉ xem) ở cột trái
...
#### 1.2.4. Các trường nhập trên Tab Đổi mật khẩu
...
#### 1.2.6. Quy trình cập nhật thông tin cá nhân
...
#### 1.2.8. Lưu ý / Ràng buộc nghiệp vụ và bảng tổng hợp thông báo



##### 1.2.8.1. Trạng thái tài khoản — khóa, xóa
...
##### 1.2.8.2. Phiên đăng nhập tự hết hạn
...
##### 1.2.8.3. Phạm vi thay đổi thông tin
...
### 2.8. Cách dùng dashboard hằng ngày
...
#### 2.9.1. Phạm vi dữ liệu phụ thuộc vai trò
...
#### 2.9.2. Dữ liệu được làm mới khi nào?
...
#### 2.9.3. Khi nào số liệu hiển thị bằng 0?
...
#### 2.9.5. Tương tác trên thẻ thống kê
...
## 3. Thông báo (Chuông cá nhân + Thông báo nội bộ)
...
### 3.2. Bố cục Chuông trên thanh đầu trang
...
### 3.3. Bố cục Trang Thông báo nội bộ (`/thong-bao`)
...
#### 3.6.1. Xem nhanh thông báo cá nhân qua chuông
...
#### 3.6.2. Mở chi tiết một thông báo cá nhân
...
#### 3.6.4. Tạo thông báo nội bộ (chỉ Quản trị viên)
...
#### 3.6.5. Lọc thông báo trên trang Thông báo
...
### 3.7. Lưu ý / Ràng buộc nghiệp vụ

#### 3.7.1. Hai vùng thông báo độc lập
...
#### 3.7.2. Tự động cập nhật khi có thông báo mới
...
#### 3.7.3. Phạm vi cá nhân của trạng thái đọc
...
#### 3.7.4. Quyền tạo thông báo nội bộ
...
#### 3.7.5. Giới hạn ký tự khi tạo thông báo
...
#### 3.7.6. Hiển thị tối đa 10 trong chuông, 20 trong trang
...
### 4.3. Các cột trong Bảng danh sách
...
### 4.4. Bộ lọc và thanh công cụ

#### 4.4.1. Các bộ lọc (hàng phía trên bảng)
...
#### 4.4.2. Thanh nút công cụ (góc trên bên phải)
...
### 4.5. Drawer Thêm / Sửa Văn bản đến
...
### 4.6. Các trạng thái của Văn bản đến
...
### 4.8. Nội dung chi tiết các phần

#### 4.8.1. Phần "Thông tin văn bản"
...
#### 4.9.4. Khi văn bản là **Liên thông** (`is_inter_doc = true`)
...
### 4.10. Các Drawer / Modal phụ — chi tiết

#### 4.10.1. Modal Gửi văn bản
...
#### 4.10.2. Drawer Giao việc (tạo HSCV)
...
#### 4.10.4. Modal Chuyển lại (chỉ VB liên thông)
...
#### 4.10.5. Modal Gửi liên thông LGSP
...
#### 4.10.6. Drawer Chuyển lưu trữ *(tạm ẩn)*
...
### 4.11. Quy trình nghiệp vụ chính

#### 4.11.1. Văn thư tiếp nhận và vào sổ văn bản đến
...
#### 4.11.2. Lãnh đạo duyệt và bút phê
...
#### 4.11.3. Lãnh đạo giao việc qua HSCV
...
#### 4.11.5. Văn thư rà soát và lưu trữ
...
#### 4.11.6. Liên thông LGSP — gửi và nhận
...
### 4.12. Sơ đồ vòng đời văn bản đến
...
### 4.13. Lưu ý / Ràng buộc nghiệp vụ

#### 4.13.1. Số đến tự động — theo sổ và năm
...
#### 4.13.2. Nguồn văn bản và quyền sửa
...
#### 4.13.3. Không xóa được văn bản đã duyệt
...
#### 4.13.4. Thu hồi — xóa người nhận, đặt lại Chờ duyệt
...
#### 4.13.5. "Gửi cho tôi" — đồng nghiệp gửi thay
...
#### 4.13.6. Đánh dấu đã đọc tự động
...
### 5.3. Các cột trong Bảng Văn bản đi
...
### 5.4. Bộ lọc nhanh phía trên bảng
...
### 5.5. Các trạng thái của Văn bản đi
...
### 5.6. Cửa sổ Soạn / Sửa văn bản đi
...
#### 5.6.2. Nút Tạo mới / Cập nhật / Hủy
...
### 5.8. Các khối thông tin trong màn Chi tiết

#### 5.8.1. Khối "Thông tin văn bản"
...
#### 5.8.2. Khối "Đơn vị / Cơ quan nhận" (cột phải)
...
#### 5.8.3. Khối "Người nhận" (cột phải)
...
#### 5.8.4. Khối "Tài liệu đính kèm" (cột trái)
...
#### 5.8.5. Khối "Ý kiến lãnh đạo" (cột phải)
...
#### 5.8.6. Khối "Lịch sử xử lý" (cột phải)
...
### 5.9. Các nút thao tác theo từng trạng thái
...
#### 5.9.1. Khi văn bản ở trạng thái **Chờ duyệt**
...
#### 5.9.2. Khi văn bản ở trạng thái **Đã duyệt** nhưng **Chưa ban hành**
...
#### 5.9.3. Khi văn bản ở trạng thái **Đã ban hành** nhưng **Chưa gửi**
...
#### 5.9.4. Khi văn bản ở trạng thái **Đã gửi** (`status = 'sent'`)
...
### 5.10. Quy trình nghiệp vụ chính

#### 5.10.1. Soạn và trình một văn bản đi mới
...
#### 5.10.3. Văn thư ban hành và gửi
...
#### 5.10.5. Giao việc / Thêm vào hồ sơ công việc
...
### 5.11. Sơ đồ vòng đời văn bản đi
...
### 5.12. Lưu ý / Ràng buộc nghiệp vụ

#### 5.12.1. Quy tắc cấp số
...
#### 5.12.3. Không sửa được khi đã duyệt
...
#### 5.12.4. Không hủy duyệt được khi đã gửi
...
#### 5.12.5. Phải duyệt trước khi gửi
...
### 6.4. Các cột trong Bảng danh sách
...
### 6.7. Các thẻ thông tin trên màn hình Chi tiết

#### 6.7.1. Thẻ "Thông tin văn bản dự thảo"
...
### 6.8. Nhãn "Đánh dấu cá nhân" (ngôi sao)
...
### 6.9. Các nút thao tác theo trạng thái
...
#### 6.9.1. Quyền (do hệ thống tự tính)
...
#### 6.9.2. Bảng nút theo trạng thái — màn Chi tiết
...
#### 6.9.3. Bảng nút theo trạng thái — màn Danh sách (menu ba chấm)
...
### 6.10. Cửa sổ Thêm mới / Sửa văn bản dự thảo
...
### 6.11. Quy trình thao tác chính

#### 6.11.1. Soạn thảo và trình duyệt
...
#### 6.11.2. Lãnh đạo cho ý kiến / duyệt / từ chối
...
#### 6.11.3. Hủy duyệt để cán bộ chỉnh sửa
...
#### 6.11.4. Ký số file đính kèm (tùy chọn)
...
#### 6.11.5. Phát hành thành Văn bản đi
...
#### 6.11.6. Thu hồi (trước khi phát hành)
...
### 6.13. Lưu ý / Ràng buộc nghiệp vụ

#### 6.13.1. Sửa / Xóa chỉ trước khi duyệt và phát hành
...
#### 6.13.4. Trùng người nhận khi gửi
...
#### 6.13.6. Định dạng và giới hạn dữ liệu
...
## 7. Màn hình Văn bản đánh dấu cá nhân
...
### 7.3. Các cột trong bảng danh sách
...
#### 7.6.3. Kiểm tra lại trên màn hình Văn bản đánh dấu cá nhân
...
### 7.7. Lưu ý / Ràng buộc nghiệp vụ

#### 7.7.1. Phạm vi cá nhân — không chia sẻ
...
#### 7.7.2. Đánh dấu không thay thế chức năng tìm kiếm
...
#### 7.7.3. Hai mức đánh dấu: Thường và Quan trọng
...
#### 7.7.4. Bỏ đánh dấu không xóa văn bản gốc
...
### 8.3. Các cột trong bảng danh sách cán bộ (cột trái)
...
### 8.4. Khu vực "Đã chọn gửi nhanh" (cột phải)
...
### 8.6. Quy trình thao tác

#### 8.6.1. Lần đầu thiết lập danh sách gửi nhanh
...
#### 8.6.2. Cập nhật (thêm / bớt) cán bộ trong danh sách
...
#### 8.6.3. Xóa toàn bộ danh sách gửi nhanh
...
#### 8.6.4. Sử dụng danh sách gửi nhanh khi xử lý văn bản
...
### 8.7. Lưu ý / Ràng buộc nghiệp vụ

#### 8.7.1. Phạm vi cá nhân — không chia sẻ
...
#### 8.7.2. "Tick sẵn" chứ không "tự động gửi"
...
#### 8.7.4. Lưu là "ghi đè", không phải "thêm vào"
...
#### 8.7.5. Tìm kiếm và phân trang phía máy chủ
...
### 9.4. Bộ lọc phụ và thanh công cụ

#### 9.4.1. Hàng bộ lọc phụ (phía dưới các tab)
...
#### 9.4.2. Thanh nút công cụ (góc trên bên phải)
...
### 9.5. Các cột trong Bảng danh sách
...
### 9.6. Các trạng thái HSCV hiển thị trong Bảng
...
### 9.7. Các nút thao tác trên dòng (menu ba chấm dọc)
...
#### 9.7.1. HSCV ở trạng thái **Mới tạo** (status = 0)
...
#### 9.7.2. HSCV ở các trạng thái còn lại (Đang xử lý / Chờ trình ký / Đã trình ký / Hoàn thành / Trả về / Bị từ chối / Đã hủy)
...
### 9.8. Các trường nhập liệu trong Drawer Tạo / Chỉnh sửa HSCV
...
### 9.9. Quy trình thao tác chính

#### 9.9.1. Tạo một HSCV mới
...
#### 9.9.3. Sửa hoặc Xóa HSCV vừa tạo
...
#### 9.9.4. Mở chi tiết HSCV để thao tác chuyên sâu
...
### 9.10. Lưu ý / Ràng buộc nghiệp vụ

#### 9.10.1. Sửa và Xóa chỉ áp dụng khi HSCV "Mới tạo"
...
#### 9.10.2. Phạm vi quyền xem dữ liệu
...
#### 9.10.3. Hạn giải quyết phải ≥ Ngày mở
...
#### 9.10.4. Cảnh báo Quá hạn trên cột "Hạn giải quyết"
...
#### 9.10.5. Lãnh đạo ký phải đăng ký từ trước
...
## 10. Màn hình Chi tiết Hồ sơ công việc
...
### 10.3. Trạng thái của Hồ sơ công việc
...
### 10.4. Các Tab trong chi tiết HSCV

#### 10.4.1. Tab "Thông tin chung"
...
### 10.5. Các nút hành động theo từng trạng thái
...
#### 10.5.1. Khi HSCV ở trạng thái **"Mới tạo"**
...
#### 10.5.2. Khi HSCV ở trạng thái **"Đang xử lý"**
...
#### 10.5.3. Khi HSCV ở trạng thái **"Đã trình ký"**
...
#### 10.5.4. Khi HSCV ở trạng thái **"Hoàn thành"**
...
#### 10.5.5. Khi HSCV bị **"Từ chối"** hoặc **"Trả về"**
...
### 10.6. Các thao tác quan trọng — Giải thích chi tiết
...
#### 10.6.5. Trả về / Từ chối

*[Hình minh họa: Cửa sổ Trả về / Từ chối]*
...
#### 10.6.7. Mở lại HSCV (sau khi đã hoàn thành)
...
#### 10.6.8. Ký số trên file đính kèm
...
### 10.7. Quy trình nghiệp vụ tham khảo
...
## 11. Màn hình Hồ sơ công việc > Báo cáo
...
### 11.8. Quy trình xem và xuất báo cáo

#### 11.8.1. Xem báo cáo theo phòng ban
...
#### 11.8.2. Xem báo cáo theo cán bộ giải quyết / người giao
...
### 11.9. Lưu ý / Ràng buộc nghiệp vụ

#### 11.9.1. Phạm vi dữ liệu giới hạn theo đơn vị của người đăng nhập
...
#### 11.9.2. "Chuyển kỳ trước" và "Kỳ này" — phân biệt thế nào?
...
#### 11.9.3. Quy ước trạng thái hồ sơ công việc
...
#### 11.9.4. Tỷ lệ hoàn thành (cột "Tỷ lệ hoàn thành %" trong bảng)
...
#### 11.9.5. Bảng báo cáo Theo cán bộ / Theo người giao chỉ hiện cán bộ có hoạt động
...
#### 11.9.7. Báo cáo không tự làm mới
...
#### 11.9.8. Phân trang bảng báo cáo
...
## 12. Màn hình Ký số > Cấu hình ký số hệ thống
...
### 12.3. Thông tin hiển thị trên Thẻ provider
...
### 12.4. Các trường nhập liệu trong cửa sổ Sửa cấu hình
...
### 12.6. Quy trình thao tác chính

#### 12.6.1. Cấu hình lần đầu một provider (chưa từng nhập credentials)
...
#### 12.6.2. Sửa lại cấu hình đang dùng (giữ nguyên Client Secret cũ)
...
#### 12.6.3. Chuyển provider đang kích hoạt (sang provider khác)
...
#### 12.6.4. Kiểm tra kết nối tới provider

Có **2 cách** kiểm tra kết nối, đều ở trong cửa sổ Sửa cấu hình:

##### 12.6.4.1. a) Kiểm tra cấu hình đã lưu
...
##### 12.6.4.2. b) Kiểm tra với secret mới
...
### 12.7. Lưu ý / Ràng buộc nghiệp vụ

#### 12.7.1. Hệ thống cố định chỉ hỗ trợ 2 provider
...
#### 12.7.2. Tại một thời điểm chỉ có một provider được kích hoạt
...
#### 12.7.3. Không thể xem lại Client Secret đã lưu
...
#### 12.7.4. Bắt buộc kiểm tra kết nối trước khi kích hoạt
...
#### 12.7.6. Profile ID — chỉ áp dụng cho MySign Viettel
...
#### 12.7.7. Kết quả kiểm tra kết nối được lưu lại
...
## 13. Màn hình Ký số > Tài khoản ký số cá nhân
...
### 13.3. Các trường nhập liệu trong biểu mẫu

Các trường thay đổi tùy theo nhà cung cấp dịch vụ đang hoạt động.

#### 13.3.1. Khi nhà cung cấp là SmartCA VNPT
...
#### 13.3.2. Khi nhà cung cấp là MySign Viettel
...
#### 13.3.3. Khối thông tin chứng thư (chỉ đọc, hiển thị sau khi đã xác thực)
...
### 13.5. Quy trình thao tác chính

#### 13.5.1. Trường hợp 1 — Hệ thống chưa kích hoạt nhà cung cấp dịch vụ
...
#### 13.5.2. Trường hợp 2 — Khai báo tài khoản với SmartCA VNPT
...
*[Hình minh họa: Đã xác thực thành công]*

#### 13.5.3. Trường hợp 3 — Khai báo tài khoản với MySign Viettel
...
*[Hình minh họa: Tải danh sách chứng thư MySign]*

#### 13.5.4. Cập nhật lại Mã định danh hoặc đổi Chứng thư số
...
### 13.6. Lưu ý / Ràng buộc nghiệp vụ

#### 13.6.1. Mỗi tài khoản người dùng có một cấu hình riêng
...
#### 13.6.2. Một tài khoản — một cấu hình theo đúng nhà cung cấp đang hoạt động
...
#### 13.6.3. Điều kiện cần để có thể ký số văn bản
...
#### 13.6.4. Sau khi Lưu cấu hình, BẮT BUỘC phải Xác thực lại
...
#### 13.6.5. Nút Xác thực bị vô hiệu hóa khi chưa Lưu lần nào
...
#### 13.6.6. Với MySign Viettel: PHẢI tải danh sách chứng thư trước khi chọn
...
#### 13.6.7. Thời điểm xác thực gần nhất được ghi lại
...
#### 13.6.8. Lỗi kết nối đến nhà cung cấp dịch vụ
...
#### 13.6.9. Khi xác thực thất bại nhưng không phải do lỗi mạng
...
## 14. Màn hình Ký số > Danh sách ký số
...
### 14.4. Các cột trong bảng danh sách
...
### 14.6. Quy trình thao tác chính

#### 14.6.1. Ký số một tệp đính kèm
...
#### 14.6.2. Hủy một giao dịch đang xử lý
...
#### 14.6.4. Ký lại một giao dịch thất bại
...
### 14.7. Lưu ý / Ràng buộc nghiệp vụ

#### 14.7.1. Điều kiện hệ thống — Cấu hình nhà cung cấp
...
#### 14.7.2. Điều kiện cá nhân — Tài khoản ký số đã xác thực
...
#### 14.7.4. Không ký số văn bản đến
...
#### 14.7.6. Thời hạn xác nhận OTP — 3 phút
...
#### 14.7.7. Cài Root CA Viettel để hiển thị chữ ký hợp lệ
...
#### 14.7.8. Cập nhật theo thời gian thực
...
#### 14.7.9. Phạm vi cá nhân — không chia sẻ
...
### 15.3. Các cột trong Bảng danh sách đơn vị
...
### 15.4. Các trường nhập liệu trong cửa sổ Thêm / Cập nhật đơn vị
...
### 15.6. Quy trình thao tác chính

#### 15.6.1. Thêm mới một đơn vị / phòng ban
...
#### 15.6.2. Chỉnh sửa thông tin một đơn vị
...
#### 15.6.5. Tìm kiếm trên cây cơ cấu tổ chức
...
### 15.7. Lưu ý / Ràng buộc nghiệp vụ

#### 15.7.1. "Đơn vị" và "Phòng ban" — phân biệt thế nào?
...
#### 15.7.2. Mã đơn vị phải duy nhất
...
#### 15.7.3. Không xóa được đơn vị còn dữ liệu liên quan
...
#### 15.7.4. Thứ tự sắp xếp (sort_order)
...
#### 15.7.5. "Cho phép sổ VB" — ý nghĩa nghiệp vụ
...
#### 15.7.6. Định dạng SDT, Fax, Email
...
### 16.3. Các cột trong Bảng danh sách chức vụ
...
### 16.4. Các trường nhập liệu trong cửa sổ Thêm / Cập nhật chức vụ
...
### 16.6. Quy trình thao tác chính

#### 16.6.1. Thêm mới một chức vụ
...
#### 16.6.2. Chỉnh sửa thông tin một chức vụ
...
#### 16.6.3. Ngừng / Kích hoạt lại một chức vụ
...
### 16.7. Lưu ý / Ràng buộc nghiệp vụ

#### 16.7.1. "Chức vụ lãnh đạo" — ý nghĩa nghiệp vụ
...
#### 16.7.2. "Được xử lý văn bản" — ý nghĩa nghiệp vụ
...
#### 16.7.3. Mã chức vụ phải duy nhất
...
#### 16.7.5. Không xóa được chức vụ còn nhân viên đang giữ
...
#### 16.7.6. Mã và tên — không nên thay đổi sau khi đã sử dụng
...
## 17. Màn hình Quản trị > Người dùng
...
### 17.3. Các cột trong Bảng danh sách người dùng
...
### 17.4. Các trường nhập liệu trong cửa sổ Thêm / Sửa người dùng
...
#### 17.4.1. Cột trái — Thông tin tài khoản và cá nhân
...
#### 17.4.2. Cột phải — Tổ chức và thông tin cá nhân
...
### 17.6. Quy trình thao tác chính

#### 17.6.1. Thêm mới một người dùng
...
#### 17.6.2. Chỉnh sửa thông tin một người dùng
...
#### 17.6.5. Phân quyền cho người dùng
...
### 17.7. Lưu ý / Ràng buộc nghiệp vụ

#### 17.7.1. Tên đăng nhập là khóa duy nhất, không sửa được sau khi tạo
...
#### 17.7.3. Email phải duy nhất nếu có
...
#### 17.7.4. Đơn vị và Phòng ban phải đi đôi
...
#### 17.7.5. Định dạng Tên đăng nhập
...
#### 17.7.6. Định dạng SDT, Di động, Email
...
#### 17.7.7. Mã nhân viên do hệ thống tự sinh
...
#### 17.7.8. Tách biệt rõ "Sửa thông tin" và các thao tác bảo mật
...
## 18. Màn hình Quản trị > Nhóm quyền
...
### 18.3. Các cột trong Bảng danh sách nhóm quyền
...
### 18.4. Các trường nhập liệu trong cửa sổ Thêm / Cập nhật nhóm quyền
...
### 18.6. Quy trình thao tác chính

#### 18.6.1. Thêm mới một nhóm quyền
...
#### 18.6.2. Chỉnh sửa thông tin một nhóm quyền
...
#### 18.6.3. Phân quyền cho một nhóm quyền
...
### 18.7. Lưu ý / Ràng buộc nghiệp vụ

#### 18.7.1. Cộng dồn quyền từ nhiều nhóm
...
#### 18.7.2. Tên nhóm quyền phải duy nhất
...
#### 18.7.3. Không xóa được nhóm quyền còn nhân viên thuộc về
...
#### 18.7.4. Phân quyền là ghi đè toàn bộ
...
#### 18.7.5. Xóa nhóm sẽ gỡ luôn các chức năng đã phân quyền
...
## 19. Màn hình Quản trị > Sổ văn bản
...
### 19.3. Các cột trong Bảng danh sách sổ văn bản
...
### 19.4. Các trường nhập liệu trong cửa sổ Thêm / Cập nhật sổ văn bản
...
### 19.6. Quy trình thao tác chính

#### 19.6.1. Thêm mới một sổ văn bản
...
#### 19.6.2. Chỉnh sửa thông tin một sổ văn bản
...
#### 19.6.3. Đặt một sổ làm sổ mặc định
...
#### 19.6.5. Chuyển giữa các nhóm sổ
...
### 19.7. Lưu ý / Ràng buộc nghiệp vụ

#### 19.7.1. Phạm vi sổ — Đơn vị, không phải Phòng ban
...
#### 19.7.2. Phân nhóm sổ — Cố định khi tạo
...
#### 19.7.3. Sổ mặc định — Quy tắc duy nhất
...
#### 19.7.4. Tên sổ phải duy nhất trong phạm vi (đơn vị + nhóm)
...
#### 19.7.5. Xóa mềm — Bảo toàn dữ liệu lịch sử
...
## 20. Màn hình Quản trị > Loại văn bản
...
### 20.3. Các cột trong bảng danh sách loại văn bản
...
### 20.4. Các trường nhập liệu trong cửa sổ Thêm / Cập nhật loại văn bản
...
### 20.6. Quy trình thao tác chính

#### 20.6.1. Thêm mới một loại văn bản
...
#### 20.6.2. Chỉnh sửa thông tin một loại văn bản
...
#### 20.6.4. Chuyển nhóm văn bản (Đến / Đi / Dự thảo)
...
### 20.7. Lưu ý / Ràng buộc nghiệp vụ

#### 20.7.1. Mã loại văn bản phải duy nhất
...
#### 20.7.2. Không xóa được loại văn bản còn loại con
...
#### 20.7.3. "Kiểu ký hiệu" — ý nghĩa nghiệp vụ
...
### 21.3. Các cột trong Bảng danh sách lĩnh vực
...
### 21.4. Các trường nhập liệu trong cửa sổ Thêm / Cập nhật lĩnh vực
...
### 21.6. Quy trình thao tác chính

#### 21.6.1. Thêm mới một lĩnh vực
...
#### 21.6.2. Chỉnh sửa thông tin một lĩnh vực
...
### 21.7. Lưu ý / Ràng buộc nghiệp vụ

#### 21.7.1. Mã lĩnh vực — duy nhất trong đơn vị
...
#### 21.7.3. "Ngừng" hay "Xóa" — nên chọn cách nào?
...
#### 21.7.4. Thứ tự sắp xếp (sort_order)
...
#### 21.7.5. Phạm vi dữ liệu theo đơn vị
...
### 22.3. Các cột trong Bảng danh sách người ký
...
### 22.4. Các trường trong hộp thoại Thêm người ký
...
### 22.6. Quy trình thao tác chính

#### 22.6.1. Thêm mới một người ký
...
#### 22.6.3. Lọc danh sách theo phòng ban
...
#### 22.6.4. Tìm kiếm phòng ban trên cây
...
### 22.7. Lưu ý / Ràng buộc nghiệp vụ

#### 22.7.1. Một nhân viên chỉ được thêm một lần trong cùng đơn vị
...
#### 22.7.2. Nhân viên đã xóa không thể chọn làm người ký
...
#### 22.7.3. Phải chọn phòng ban / đơn vị trước khi thêm
...
#### 22.7.6. Liên hệ với chức năng "Soạn văn bản đi" / "Dự thảo"
