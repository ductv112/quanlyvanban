...
Chi tiết: xem mục [Đăng nhập và Thông tin cá nhân](HDSD_dang_nhap_va_thong_tin_ca_nhan.md).
...
| **Tin nhắn chưa đọc** | Số tin nhắn nội bộ gửi đến cá nhân chưa đọc. | Tin nhắn |
| **Thông báo chưa đọc** | Số thông báo (hệ thống / đơn vị) chưa đọc. | Thông báo |
| **Lịch họp hôm nay** | Số cuộc họp / sự kiện sử dụng phòng họp diễn ra trong ngày hôm nay. | Lịch cơ quan |
...
| **Soạn tin nhắn** | Chuyển đến màn hình Tin nhắn. |
| **Tạo HSCV** | Chuyển đến màn hình Hồ sơ công việc. |
| **Tạo lịch** | Chuyển đến màn hình Lịch cá nhân. |
...
#### 13.8. Bảng tổng hợp các thông báo của hệ thống

| Tình huống | Thông báo |
|---|---|
| Tạo VB thành công | Tạo văn bản đến thành công |
| Sửa VB thành công | Cập nhật văn bản đến thành công |
| Xóa VB thành công | Xóa văn bản đến thành công |
| Để trống Trích yếu | Trích yếu nội dung không được để trống |
| Để trống Sổ văn bản | Sổ văn bản là bắt buộc |
| Sửa VB đã duyệt | Không thể sửa văn bản đã được duyệt |
| Xóa VB đã duyệt | Không thể xóa văn bản đã được duyệt |
| VB đến không tồn tại | Không tìm thấy văn bản đến |
| Sửa VB nguồn nội bộ/LGSP | Văn bản đến từ đơn vị nội bộ không được sửa nội dung gốc. Chỉ có thể tiếp nhận / phân công xử lý / từ chối. |
| Không có quyền sửa | Không có quyền sửa văn bản đến này |
| Không có quyền duyệt | Không có quyền duyệt văn bản đến này |
| Không có quyền hủy duyệt | Không có quyền hủy duyệt văn bản đến này |
| Không có quyền gửi | Không có quyền gửi văn bản đến này |
| Không có quyền thu hồi | Không có quyền thu hồi văn bản đến này |
| Không có quyền giao việc | Không có quyền giao xử lý văn bản đến này |
| Không có quyền thêm vào HSCV | Không có quyền thêm vào hồ sơ công việc |
| Không có quyền gửi liên thông | Không có quyền gửi liên thông văn bản đến này |
| Không có quyền nhận bản giấy | Không có quyền xác nhận nhận bản giấy |
| Không có quyền chuyển lại | Không có quyền chuyển lại văn bản đến này |
| Duyệt thành công | Duyệt văn bản thành công |
| Hủy duyệt VB chưa duyệt | Văn bản chưa được duyệt, không thể hủy duyệt |
| Hủy duyệt thành công | Hủy duyệt văn bản thành công |
| Hủy duyệt khi đã gửi | Không thể hủy duyệt: văn bản đã được gửi cho cán bộ |
| Gửi cán bộ — VB chưa duyệt | Văn bản chưa được duyệt, không thể gửi |
| Gửi cán bộ — chưa chọn người | Vui lòng chọn ít nhất một người nhận |
| Gửi cán bộ thành công | Đã gửi cho [N] người nhận |
| Thu hồi thành công | Thu hồi thành công — đã xóa [N] người nhận |
| Nhận bản giấy thành công | Đã xác nhận nhận bản giấy |
| Nhận bàn giao thành công | Nhận bàn giao thành công |
| Chuyển lại — lý do trống | Lý do chuyển lại không được để trống / Lý do chuyển lại là bắt buộc |
| Chuyển lại — lý do dưới 10 ký tự | Lý do chuyển lại phải có ít nhất 10 ký tự |
| Chuyển lại thành công | Chuyển lại văn bản thành công |
| Bút phê — nội dung trống | Nội dung bút phê không được để trống |
| Bút phê + phân công thành công | Bút phê thành công, đã phân công [N] cán bộ |
| Thêm bút phê thành công | Thêm bút phê thành công |
| Đánh dấu đã đọc thành công | Đã đánh dấu đọc thành công |
| Giao việc — chưa nhập tên hồ sơ | Tên hồ sơ công việc là bắt buộc |
| Giao việc — chưa chọn người | Vui lòng chọn ít nhất một người thực hiện |
| Giao việc thành công | Tạo hồ sơ công việc thành công / Giao việc thành công |
| Thêm vào HSCV — chưa chọn | Vui lòng chọn hồ sơ công việc |
| Gửi liên thông — chưa chọn đơn vị | Vui lòng chọn ít nhất một đơn vị |
| Gửi liên thông thành công | Đã gửi liên thông cho [N] đơn vị |
| Upload file — chưa chọn | Vui lòng chọn file |
...
#### 12.10. Bảng tổng hợp các thông báo của hệ thống

| Tình huống | Thông báo |
|---|---|
| Tạo văn bản thành công | Tạo văn bản đi thành công |
| Cập nhật văn bản thành công | Cập nhật văn bản đi thành công / Cập nhật thành công |
| Xóa văn bản thành công | Xóa văn bản đi thành công / Đã xóa |
| Duyệt thành công | Duyệt văn bản đi thành công / Duyệt thành công |
| Hủy duyệt thành công | Hủy duyệt thành công |
| Từ chối thành công | Đã từ chối văn bản đi / Đã từ chối |
| Thu hồi thành công | Thu hồi thành công — đã xóa N người nhận / Thu hồi thành công |
| Ban hành thành công | Ban hành thành công |
| Gửi thành công | Đã gửi: N đơn vị nội bộ, M cơ quan ngoài LGSP |
| Trích yếu để trống | Trích yếu nội dung không được để trống / Trích yếu nội dung là bắt buộc |
| Sổ văn bản để trống | Sổ văn bản là bắt buộc |
| Tên hồ sơ công việc khi giao việc để trống | Tên hồ sơ công việc là bắt buộc |
| Ý kiến lãnh đạo trống | Nội dung ý kiến là bắt buộc |
| Đánh dấu đã đọc thành công | Đã đánh dấu đọc thành công / Đã đánh dấu đọc |
| Tải file thành công | Tải lên thành công |
| Sửa văn bản đã duyệt | Không thể sửa văn bản đã được duyệt |
| Xóa văn bản đã duyệt | Không thể xóa văn bản đã được duyệt |
| Hủy duyệt khi đã gửi | Không thể hủy duyệt: văn bản đã được gửi cho cán bộ |
| Văn bản chưa duyệt → gửi | Văn bản chưa được duyệt, không thể gửi |
| Văn bản chưa ban hành → gửi | Văn bản chưa ban hành, không thể gửi |
| Văn bản đã ban hành rồi → ban hành lại | Văn bản đã ban hành trước đó / Van ban da ban hanh truoc do |
| Gửi mà chưa chọn người | Vui lòng chọn ít nhất một người nhận |
| Gửi mà chưa có nơi nhận | Chưa có nơi nhận |
| Không tìm thấy văn bản | Không tìm thấy văn bản đi |
| Không có quyền sửa | Không có quyền sửa văn bản đi này |
| Không có quyền duyệt | Không có quyền duyệt văn bản đi này |
| Không có quyền ban hành | Không có quyền ban hành văn bản đi này |
| Không có quyền gửi | Không có quyền gửi văn bản đi này |
| Không có quyền thu hồi | Không có quyền thu hồi văn bản đi này |
| Không có quyền giao việc | Không có quyền giao xử lý văn bản đi này |
| Không có quyền thêm vào HSCV | Không có quyền thêm vào hồ sơ công việc |
...
| Tình huống | Thông báo |
|---|---|
| Thêm chức vụ thành công | Thêm thành công |
| Cập nhật chức vụ thành công | Cập nhật thành công |
| Xóa chức vụ thành công | Xóa thành công |
| Để trống Tên chức vụ | Tên chức vụ là bắt buộc |
| Mã chức vụ trùng | Mã chức vụ đã tồn tại |
| Sửa nhưng không tìm thấy bản ghi | Không tìm thấy chức vụ |
| Tạo mới thất bại do lỗi hệ thống | Không thể tạo chức vụ |
| Xóa chức vụ còn nhân viên | Không thể xóa: còn N nhân viên đang sử dụng chức vụ này |
| Xác nhận trước khi xóa | Bạn có chắc chắn muốn xóa chức vụ này? |
| Lỗi tải danh sách | Lỗi tải dữ liệu |
| Lỗi khi xóa | Lỗi khi xóa |
| Trường Tên chức vụ trống (cảnh báo trên form) | Nhập tên chức vụ |
| Trường Mã trống (cảnh báo trên form) | Nhập mã |
...
| **Thứ tự** | Không | Số nguyên không âm, dùng để sắp xếp thứ tự hiển thị các sổ trong cùng một nhóm. Số nhỏ hiển thị trước số lớn. Mặc định là 0. *(Trường này chỉ có ý nghĩa khi sửa — khi thêm mới, hệ thống dùng giá trị mặc định 0.)* |
