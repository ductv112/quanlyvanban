...
## 5. Mục lục các chức năng

### 5.1. Tổng quan và cá nhân
...
| # | Chức năng | Tài liệu |
|---|---|---|
| 4 | Văn bản đến (danh sách + chi tiết) | [HDSD_van_ban_den.md](HDSD_van_ban_den.md) |
| 5 | Văn bản đi (danh sách + chi tiết) | [HDSD_van_ban_di.md](HDSD_van_ban_di.md) |
| 6 | Văn bản dự thảo (danh sách + chi tiết) | [HDSD_van_ban_du_thao.md](HDSD_van_ban_du_thao.md) |
| 7 | Đánh dấu cá nhân | [HDSD_van_ban_danh_dau.md](HDSD_van_ban_danh_dau.md) |
| 8 | Cấu hình gửi nhanh | [HDSD_cau_hinh_gui_nhanh.md](HDSD_cau_hinh_gui_nhanh.md) |
